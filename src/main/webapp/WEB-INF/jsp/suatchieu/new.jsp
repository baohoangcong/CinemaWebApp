		...
		<div class="container bg-light p-5" style="margin-top: 100px; margin-bottom: 100px; width: 500px">
			...
			<form:form action="${pageContext.request.contextPath}/suatchieu/save" method="post" modelAttribute="SuatchieuForm">
				...
				<div class="form-group">
					...
					<form:select path="phim.maPhim" items="${phims}" itemValue="maPhim" itemLabel="tenPhim" class="form-control"></form:select>
					<div class="text-danger">
				...
				<div class="form-group">
					...
					<form:select path="phongChieu.maPhongChieu" items="${phongchieus}" itemValue="maPhongChieu" itemLabel="maPhongChieu" class="form-control"></form:select>
					<div class="text-danger">
